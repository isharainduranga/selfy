    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-item theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="index-2.html">
                    <img src="{{asset('FrontEnd/assets/img/logo.svg')}}" class="navbar-logo" alt="logo">
                </a>
            </li>
        ...
        <ul class="navbar-item flex-row ml-md-auto">
            ...
            <li class="nav-item dropdown language-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown"
                    ...
                    <img src="{{asset('FrontEnd/assets/img/ca.png')}}" class="flag-width" alt="flag">
                </a>
                <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                            src="{{asset('FrontEnd/assets/img/de.png')}}" class="flag-width" alt="flag"> <span
                            class="align-self-center">&nbsp;German</span></a>
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                            src="{{asset('FrontEnd/assets/img/jp.png')}}" class="flag-width" alt="flag"> <span
                            class="align-self-center">&nbsp;Japanese</span></a>
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                            src="{{asset('FrontEnd/assets/img/fr.png')}}" class="flag-width" alt="flag"> <span
                            class="align-self-center">&nbsp;French</span></a>
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                            src="{{asset('FrontEnd/assets/img/ca.png')}}" class="flag-width" alt="flag"> <span
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <img class="usr-img rounded-circle"
                                            src="{{asset('FrontEnd/assets/img/profile-11.jpg')}}" alt="profile">
                                    </div>
                        ...
                        <a class="dropdown-item">
                            <div class="">
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <img class="usr-img rounded-circle"
                                            src="{{asset('FrontEnd/assets/img/profile-16.jpg')}}" alt="profile">
                                    </div>
                                    <div class="media-body">
                                        <div class="">
                        ...
                        <a class="dropdown-item">
                            <div class="">
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <img class="usr-img rounded-circle"
                                            src="{{asset('FrontEnd/assets/img/profile-34.jpg')}}" alt="profile">
                                    </div>
                                    <div class="media-body">
                                        <div class="">
            ...
            <li class="nav-item dropdown user-profile-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown"
                    ...
                    <img src="{{asset('FrontEnd/assets/img/profile-16.jpg')}}" alt="avatar">
                </a>
